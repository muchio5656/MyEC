			...
			<div class="row">
				<div class="form-group col s6">
					<label>Eメールアドレス</label> <input class="form-control"
						name="mailAddress" placeholder="Enter email">
				</div>
				<div class="form-group col s6">
					<label>名前</label> <input type="text" class="form-control"
						name="name" placeholder="田中　太朗">
				</div>
			</div>
			<br>
			<div class="row">
				<div class="form-group col s6">
					<label>住所</label> <input type="text" class="form-control"
						name="address" placeholder="○○県○○市1-1-1">
				</div>
				<div class="form-group col s6">
					<label>生年月日</label> <input type="date" name="birthDate"
						class="form-control">
				</div>
			</div>
			<div class="row">
				...
				<div class="form-group col s6">
					<label for="exampleInputPassword2">パスワード：確認用</label> <input
